define main_compile
	...
	$(Q)(patch -R --dry-run -s "$(src_dir_initramfs)/initramfs/Makefile" < "$(src_dir_initramfs)/Makefile.patch" && echo "Patch already applied" || patch -N -r - -s "$(src_dir_initramfs)/initramfs/Makefile" < "$(src_dir_initramfs)/Makefile.patch")
