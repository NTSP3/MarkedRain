...
src_dir					:= source
src_dir_apps			:= $(src_dir)/applications
src_dir_buildroot		:= $(src_dir)/buildroot
src_dir_conf			:= $(src_dir)/configs
src_dir_initramfs		:= $(src_dir)/initramfs/source
src_dir_linux			:= $(src_dir)/kernel
src_dir
