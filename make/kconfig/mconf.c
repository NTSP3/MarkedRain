...
" Overview (most of the stuff is from busybox)\n"
"------------------------------------------------\n"
"Hello there! You are in help, this giant text box that appears\n"
"over the menus. Most options have some help context, just click\n"
"on the help button. The code is taken from busybox because I'm\n"
"not smart enough to understand these stuff. I just added this\n"
"because it would look nice.\n"
"\n"
"The following states the types of available settings to change:\n"
"\n"
"(1): Options beginning with [*] are togglable. They cycle between true\n"
"     and false values for options that may or may not directly effect the\n"
"     distro. An example of an effecting toggle is 'bool_auto_dir', while\n"
"     non-affecting would be 'bool_show_cmd'.\n"
"\n"
"(2): String values (Data Entries) ask you for an alpha-numerical input.\n"
"     They could be anything - like those specifying the output path.\n"
"\n"
"(3): Decimal values (Data Entries) also ask you for an input, but it has to\n"
"     be a number. You cannot enter letters into them. An example would be\n"
"     'val_dev_iso_size' where it asks you for the size of the iso in MB.\n"
"\n"
"(4): Radio lists are the menu-like stuff that ask you to choose an option\n"
"     displayed in a list. You cannot enter anything into them, just use\n"
"     the arrow keys to select an option from them.\n"
"\n"
"To change any of these features, highlight it with the cursor\n"
"keys and press the <Space Bar> to toggle it on [*] and off [ ].\n"
"Press <Enter> on string values to input strings into them.\n"
"\n"
"Keyboard hints:\n"
"\n"
"Menus\n"
...
static void cprint_init(void)
{
	...
	indent = 0;
	child_count = 0;
	cprint("./make/kconfig/lxdialog/lxdialog");
	cprint("--backtitle");
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	sprintf(menu_backtitle, _("MarkedRain %s Configuration"),
		sym_get_string_value(sym));
	...
	if (stat == 0) {
		...
		system("echo \"\\n\\e[36m    // Generating '.config.mk' from '.config' //\\e[0m\"; \
				...
				fi;"); // Added for MRain -- 31/5/2024 8:38 pm
		printf(_("\n"
